...
def drawShip(s):
   ...
   x = t-15
   y = -3
   display.polygon( (x+30,95+y),(x+55,95+y),(x+58,100+y),(x+59,104+y),(x+57,106+y),(x+50,110+y),(x+50,109+y),(x+53,106+y),(x+35,115+y),(x+45,105+y),(x+45,100+y),(x+40,98+y) )
   y = 14
   display.polygon( (x+30,95+y),(x+55,95+y),(x+58,100+y),(x+59,104+y),(x+57,106+y),(x+50,110+y),(x+50,109+y),(x+53,106+y),(x+35,115+y),(x+45,105+y),(x+45,100+y),(x+40,98+y))
   x = t+10
   y = -2
   ...
   x = t+78
   y= 0
   display.polygon( (x,98),(x+15,102),(x+18,102),(x+24,107),(x+27,112),(x+30,117),(x+10,122),(x+10,121),(x+15,114),(x+14,112),(x+12,110),(x+10,105) )
...
while True:
   for p in range (2):
      ...
      for s in range(200):
         for f in range(60):
            display.set_pen(display.create_pen(PALETTE[s % 8][0],PALETTE[s % 12+2][1],PALETTE[s % 12+2][2]))
            display.circle(f*30,720-s,20)
            display.set_pen(display.create_pen(PALETTE[s % 8][0],PALETTE[s % 8+5][1],PALETTE[s % 8+5][2]))
            display.circle(f*20,570-s,12)
            display.set_pen(display.create_pen(PALETTE[s % 8][0],PALETTE[s % 6+6][1],PALETTE[s % 6+6][2]))
